...
class ContactsView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request, self.template_name, {"contacts": contacts_data, "form_submitted": False}  # для индикации отправки
        )
    ...
    def post(self, request, *args, **kwargs):
        ...
        CustomerData.objects.create(name=name, phone=phone, message=message)

        contacts_data = Contacts.objects.all()
        return render(
            request, self.template_name, {"contacts": contacts_data, "form_submitted": True, "submitted_name": name}
        )
