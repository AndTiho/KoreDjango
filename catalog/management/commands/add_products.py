...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        category, _ = Category.objects.get_or_create(
            category_name="Приставки", description="Различные виды игровых устройств"
        )

        products = [
            {
                "product_name": "PlayStation 5",
                "description": "Игровая приставка от Японии",
                "category": category,
                "price": 999,
                "product_image": "photos/PS5.jpg",
            },
            {
                "product_name": "XBox",
                "description": "Игровая приставка от Америки",
                "category": category,
                "price": 799,
                "product_image": "photos/XB.jpg",
            },
        ]
